        ...
        mqttClient.setCallback(object : MqttCallbackExtended {
            ...
            override fun messageArrived(topic: String, mqttMessage: MqttMessage) {
               ...
               // textViewMsgPayload.text = str
                if (mqttMessage.toString().equals("K1V8G4"))
                {
                    pin1num=pin1num+1;
                }
                else if (mqttMessage.toString().equals("AW2RT5"))
                {
                    pin2num=pin2num+1;
                }
                else if (mqttMessage.toString().equals("QW2BT9"))
                {
                    pin3num=pin3num+1;
                }
                textViewMsgPayload.text="K1V8G4"+'\t'+pin1num.toString()+"\n"+"AW2RT5"+'\t'+pin2num.toString()+"\n"+"QW2BT9"+'\t'+pin3num.toString();
            }
